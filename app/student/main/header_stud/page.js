...
export default function Header_stud({ handleSignOut }) {
  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between h-16 px-4 md:px-6 bg-white shadow-sm dark:bg-gray-950">
      <div className=" flex items-center gap-4">
        <Link href="/student" className="flex items-center gap-2 text-2xl font-bold text-primary" prefetch={false}>
      ...
      <CartDropdown className='text-primary' />
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" sideOffset={12}>
            ...
            <DropdownMenuItem>
              <Link href="/student/main/myprofile" className="flex items-center gap-2" prefetch={false}>
                <ProfileIcon className="w-4 h-4" />
                My Profile
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/student/main/Payment/PaymentOptions" className="flex items-center gap-2" prefetch={false}>
                <CreditCardIcon className="w-4 h-4" />
                Payment
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/student/main/setting" className="flex items-center gap-2" prefetch={false}>
                <SettingsIcon className="w-4 h-4" />
                Settings
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/student//main/orderHistory" className="flex items-center gap-2" prefetch={false}>
