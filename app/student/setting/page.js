            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">Protect my account</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Enable two-factor authentication.</p>
                  </div>
                  <div className="ml-auto">
                ...
                <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">Secure my data</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Encrypt your data for added security.</p>
                  </div>
                  <div className="ml-auto">
          ...
          <section>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Contact us for any issues or questions.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="-mx-2 flex items-start space-x-4 rounded-md p-2 transition-all hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50">
                  <PhoneIcon className="mt-px h-5 w-5" />
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">Call Support</p>
