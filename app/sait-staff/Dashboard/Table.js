...
const Table = ({ employees, handleEdit, handleDelete, setIsAdding }) => {
  ...
  return (
    <div className="container mx-auto mt-8 p-4 rounded-lg ">
      <h1 className="mb-8 text-4xl font-bold text-center tracking-tight text-orange-800 sm:text-5xl lg:text-4xl">Student Management</h1>
            ...
            {employees && employees.length > 0 ? (
              employees.map((employee, index) => (
                <tr key={employee.id} className="hover:bg-gray-100">
                  ...
                  <td className="py-4 px-6 text-center">{formatPhoneNumber(employee.phone)}</td>
