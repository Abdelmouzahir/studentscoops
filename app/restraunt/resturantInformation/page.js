...
const Page = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      setImageerr("Please ensure you upload a valid image format, such as JPEG, JPG, or PNG.");
      return;
    };
    ...
    console.log(name, address, unformattedPhoneNumber, unformattedPostalCode,"image name" ,image[0].name);
  };
