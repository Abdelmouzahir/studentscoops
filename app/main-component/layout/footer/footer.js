...
               justify-center flex-col'>
        ...
        <div>
          ...
          <p className=' text-[15px] text-white w-fit hover:text-yellow-300 cursor-pointer text-opacity-30 mb-[0.7rem] ' >Student Scoops</p>
        </div>
      </div>
      <h1 className=' mt-[2rem] text-[14px] w-[80%] mx-auto text-white opacity-50'>COPYRIGHT BY STUDENT SCOOPS © 2024</h1>
    </div>
  )
}
